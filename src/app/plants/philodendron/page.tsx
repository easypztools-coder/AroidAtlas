...
export const metadata: Metadata = {
  title: "Philodendron Species — Neotropical Climbing Aroids",
  description:
    "Browse Philodendron species and cultivars with detailed care profiles and live eBay UK price tracking. Spiritus-sancti, gloriosum, melanochrysum and more.",
};
...
function getAllPhilodendronPlants(): PlantSummary[] {
...
export default function PhilodendronPage() {
  const plants = getAllPhilodendronPlants();
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-16">
      ...
      <p className="text-sm md:text-base text-muted max-w-2xl mb-12">
        Diverse neotropical climbers with striking foliage. Browse our collection of Philodendron species and cultivars.
      </p>

      {plants.length === 0 ? (
        <div className="text-center py-16">
          <p className="text-muted">No Philodendron species data available yet.</p>
