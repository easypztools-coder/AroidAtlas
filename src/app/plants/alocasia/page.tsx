...
export const metadata: Metadata = {
  title: "Alocasia Species — Bold Shield-Leaved Aroids",
  description:
    "Browse Alocasia species and cultivars with detailed care profiles and live eBay UK price tracking. Dragon scale, silver dragon, zebrina and more.",
};
